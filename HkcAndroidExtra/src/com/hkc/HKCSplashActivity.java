...
public class HKCSplashActivity extends Activity implements VoListener {
	...
	private void apiIsBlacklist() {
		...
		headers.put("apikey", String.valueOf(MiscUtils.getMetaData(this, MetaDataKey.HKC_APP_KEY)));
		try {
	...
	public void onRequestFinished(FreshResponse response) {
		...
		// Success
		if (response != null && response.getResultType() == ResultType.SUCCESS && response instanceof RankConfigHomeResponse) {
